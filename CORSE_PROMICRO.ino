...
digitalInput[INPUTS] = {
  ...
  {2, HIGH, 0, DPAD_LEFT, DPAD_LEFT},         //1P_COIN
  {0, HIGH, 0, DPAD_RIGHT, BUTTON_RB},        //SERVICE
  {1, HIGH, 0, BUTTON_RB, DPAD_RIGHT},        //TEST
  {4, HIGH, 0, BUTTON_L3, DPAD_UP},           //1P_UP
  {5, HIGH, 0, BUTTON_R3, DPAD_DOWN},         //1P_DOWN
  {6, HIGH, 0, DPAD_LEFT, DPAD_LEFT},         //1P_LEFT
  {7, HIGH, 0, DPAD_RIGHT, DPAD_RIGHT},       //1P_RIGHT
  {8, HIGH, 0, BUTTON_A, BUTTON_Y},           //1P_B1
  {9, HIGH, 0, BUTTON_B, BUTTON_BACK},        //1P_B2
  {10, HIGH, 0, BUTTON_X, BUTTON_LB},         //1P_B3
  {14, HIGH, 0, BUTTON_Y, BUTTON_Y}           //1P_B4
};
